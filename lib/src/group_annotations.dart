...
class GroupMarker extends HelpAnnotation implements Group {
  ...
  const GroupMarker({this.title, help, this.hide}) : super(help: help);
}

class StartGroup extends GroupMarker {
  const StartGroup({String title, help, bool hide})
      : super(title: title, help: help, hide: hide);
}

class CombinedGroup extends GroupMarker {
  const CombinedGroup(this.getOptions, {String title, help, bool hide})
      : super(title: title, help: help, hide: hide);
