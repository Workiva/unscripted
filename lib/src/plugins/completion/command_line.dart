...
class CommandLine {
  ...
  String get partialWord {
    ...
    while (argWord.substring(0, i) !=
            partialLine.substring(partialLine.length - i) &&
        i > 0) {
      i--;
    }
  ...
  factory CommandLine(List<String> args, {Map<String, String> environment}) {
    ...
    return new CommandLine._(line, cursor, realArgs, wordIndex);
  }

  static bool _inEnvironment(Map<String, String> environment) => const [
        'COMP_CWORD',
        'COMP_LINE',
        'COMP_POINT'
